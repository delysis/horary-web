//! Microphone owner adapted from native-platform 1d438589 (MIT/Apache-2.0).
#![forbid(unsafe_code)]
...
pub(crate) enum MicrophoneCaptureError {
    ...
    Stream(String),
    #[error("audio arrived faster than Horary’s bounded recorder could consume it")]
    QueueOverflow,
    #[error("the recording exceeded Horary’s five-minute limit")]
    DurationLimit,
