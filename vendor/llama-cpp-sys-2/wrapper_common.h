...
struct llama_rs_speculative_mtp_params {
    int32_t n_max;
    int32_t n_min;
    float p_min;
...
llama_rs_status llama_rs_speculative_mtp_init(
...
bool llama_rs_speculative_need_embd_nextn(struct llama_rs_speculative * spec);
...
void llama_rs_speculative_print_stats(const struct llama_rs_speculative * spec);
